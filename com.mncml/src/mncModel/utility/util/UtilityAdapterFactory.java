...
public class UtilityAdapterFactory extends AdapterFactoryImpl {
	...
	protected UtilitySwitch<Adapter> modelSwitch =
		new UtilitySwitch<Adapter>() {
			@Override
			public Adapter caseOperatingStateUtility(OperatingStateUtility object) {
				return createOperatingStateUtilityAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link mncModel.utility.OperatingStateUtility <em>Operating State Utility</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOperatingStateUtilityAdapter() {
		return null;
	}
