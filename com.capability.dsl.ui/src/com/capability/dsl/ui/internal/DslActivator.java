 ...
 */
package com.capability.dsl.ui.internal;

import com.capability.CapabilityRuntimeModule;
import com.capability.ui.CapabilityUiModule;
...
public class DslActivator extends AbstractUIPlugin {
    ...
    public static final String PLUGIN_ID = "com.capability.dsl.ui";
    public static final String COM_CAPABILITY_CAPABILITY = "com.capability.Capability";
    ...
    protected com.google.inject.Module getRuntimeModule(String grammar) {
        if (COM_CAPABILITY_CAPABILITY.equals(grammar)) {
            return new CapabilityRuntimeModule();
        }
    ...
    protected com.google.inject.Module getUiModule(String grammar) {
        if (COM_CAPABILITY_CAPABILITY.equals(grammar)) {
            return new CapabilityUiModule(this);
        }
        throw new IllegalArgumentException(grammar);
    }
