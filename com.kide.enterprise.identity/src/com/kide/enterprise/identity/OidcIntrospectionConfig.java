...
/**
 * Shared server-side OIDC token-introspection configuration used by every KIDE
 * authenticated network transport. Keeping this in the identity layer prevents
 * REST and LSP gateways from growing separate authentication semantics.
 */
