"""
Thesis Examples Service for KIDE Enterprise
Contains the verified, thesis-accurate DSL models, activities, operations,
capabilities, and data models directly derived from the PhD thesis and Eclipse repository.
"""

from typing import Dict, List, Any

THESIS_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "industrial_cooling": {
        "name": "Industrial Cooling System",
        "description": "Thesis synthesis case study: multi-activity cooling system with state transitions, commands, events, alarms, and data points.",
        "files": [
            {
...
"""
    ...
    "pick_and_place": {
        ...
        "description": "Thesis multi-DSL robotic cell: integrates Activity, Capability (ScannerCap), Operations (Pick/Place), and DML.",
        "files": [
            {
...
"""
    ...
    "assembly_supervisor": {
        ...
        "description": "Automotive assembly cell from thesis Section 5, integrating the repository Demo_ECRE.dml data model.",
        "files": [
            {
...
def get_template(key: str) -> Dict[str, Any] | None:
    return THESIS_TEMPLATES.get(key)
...
def list_templates() -> List[Dict[str, Any]]:
    return [
        ...
        for k, v in THESIS_TEMPLATES.items()
    ]
