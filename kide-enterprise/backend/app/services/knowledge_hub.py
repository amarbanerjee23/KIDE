...
EQUIPMENT_CATALOG: List[Dict[str, Any]] = [
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Specification §8.1, Table 8.1, Fig 8.1 & 8.2",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Specification §8.2, Table 8.1",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Specification §8.3, Table 8.1",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Specification §8.4, Table 8.1",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Specification §8.5, Table 8.1",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Specification §8.6, Table 8.1",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Specification §8.7, Table 8.1",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "IEC 61131-3, PLCopen Motion Part 1/2, Safe Torque Off (STO)",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "HART 7 Protocol Specification, ANSI/ISA-75 Control Valve Standards",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "RAPID Programming Standard, ISO 10218-1/2 Industrial Robot Safety",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "Modbus TCP Drive Profile, IEEE 519 Harmonic Control",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "EtherCAT Technology Group (ETG), IEC 61158 Fieldbus Standard",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "OIML R 117 Custody Transfer, NAMUR NE 107 Diagnostics",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "ISO 3691-4 Industrial AGV/AMR Safety, VDA 5050 Fleet Interface",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "FDA 21 CFR Part 11, ISA-88 Batch Control in Life Sciences",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "ISO 9001 Zero-Defect Optical Quality Verification",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "SunSpec Modbus Alliance Standard, IEEE 1547 Grid Interconnection",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "ISO 19973 Pneumatic Reliability, IO-Link Community Standard",
...
"""
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "specification_reference": "ISO 6983 Numerical Control (G-Code), MTConnect Standard",
