...
def export_python(model: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        'Produced automatically by KIDE Enterprise from thesis-grade MNC-ML / Activity specifications.',
...
def export_ros2(model: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        'Produced by KIDE Enterprise (PhD Thesis Compliant Architecture).',
        '"""',
        '',
        'import rclpy',
...
def export_java(model: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        '/**',
        f' * Generated Supervisory Controller for {name}.',
        ' * Produced automatically by KIDE Enterprise from thesis MNC-ML / Activity specifications.',
        ' */',
...
Generated by KIDE Enterprise (PhD Thesis Compliant Synthesis Framework).
