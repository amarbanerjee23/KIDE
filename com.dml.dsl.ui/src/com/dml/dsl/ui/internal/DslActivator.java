 ...
 */
package com.dml.dsl.ui.internal;

import com.dml.dsl.DmlRuntimeModule;
import com.dml.dsl.ui.DmlUiModule;
...
public class DslActivator extends AbstractUIPlugin {
    ...
    public static final String PLUGIN_ID = "com.dml.dsl.ui";
    public static final String COM_DML_DSL_DML = "com.dml.dsl.Dml";
    ...
    protected com.google.inject.Module getRuntimeModule(String grammar) {
        if (COM_DML_DSL_DML.equals(grammar)) {
            return new DmlRuntimeModule();
        }
