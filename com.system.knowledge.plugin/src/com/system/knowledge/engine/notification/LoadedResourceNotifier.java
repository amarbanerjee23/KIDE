...
import com.system.knowledge.engine.importer.DirectBlueprintsImporter;
 ...
 * top-level element.
 * <p>
 * This class needs to load an existing NeoEMF/Graph model to work, run {@link com.system.knowledge.engine.importer.BlueprintsImporter}
...
//            Model model = (Model) resource.getContents().get(0);
			 ...
			 * model.setName("New Name"); // Generates a log model.setName(oldName);
			 */        // Generates a log
        }
    }
}
